...
def compute_stoichiometry():
    try:
        ...
        print("Reactant Moles Computed:")
        for r in reactant_moles:
            print(f"{r}: Available = {reactant_moles[r]:.6f}, Stoichiometric Coefficient = {molesAndCompounds(r)[0]:.6f}")

        limiting_reagent = min(reactant_moles, key=lambda r: reactant_moles[r] / molesAndCompounds(r)[0])
        ...
        # Show Limiting Reagent - remains the SAME whether in grams or moles
